<template>
  <div class="m-nav">
    <ul class="nav">
      ...
      <li class="list bd">
        <nuxt-link to="/rules">美团规则</nuxt-link>
        <dl>
          <dd>
            <nuxt-link to="/rulesCenter">规则中心</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/rulesContent">规则目录</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/rulesSchool">规则评议院</nuxt-link>
          </dd>
        </dl>
      </li>
      <li class="list site">
